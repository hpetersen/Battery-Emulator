...
class TeslaBattery : public CanBattery {
 ...
 protected:
  ...
  // 0x75D CP_sensorData — the always-present (drive + charge) charge-port heartbeat. Reset experiment
  // (FINDINGS §13.10/§13.12) proved ChargePort_MIA is NOT cleared by 0x21D/0x23D/0x25D, so the MIA
  // watches THIS frame instead. It is a slow large multiplex (5 Hz, 52 mux subframes, rolling counters)
  // — for a presence-at-rate MIA we faithfully REPLAY a captured 30-frame slice (1228ChargeDrive.csv)
  // on loop at 5 Hz. DLC 8. Mutable TESLA_75D is filled from the sequence each cadence.
  static constexpr uint8_t TESLA_75D_SEQ[30][8] = {
      {0xAA, 0x04, 0xE6, 0x9F, 0x04, 0xE9, 0x0F, 0x00}, {0x01, 0x4D, 0x4D, 0x00, 0x00, 0x00, 0x00, 0x00},
      {0x82, 0x52, 0x01, 0x50, 0x5C, 0x00, 0x00, 0x00}, {0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
      {0x14, 0xF6, 0x73, 0x27, 0x00, 0x00, 0x00, 0x00}, {0x95, 0xE2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
      {0x16, 0x00, 0x00, 0x27, 0x00, 0x00, 0x00, 0x00}, {0x07, 0xEA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
      {0x08, 0x79, 0xAC, 0xFE, 0xAA, 0xE1, 0xAE, 0x02}, {0x09, 0x00, 0xCE, 0xA0, 0x02, 0x2E, 0x00, 0x00},
      {0xAA, 0x04, 0xE6, 0x9F, 0x04, 0xE9, 0x0F, 0x00}, {0x01, 0x4D, 0x4D, 0x00, 0x00, 0x00, 0x00, 0x00},
      {0x82, 0x52, 0x01, 0x50, 0x5C, 0x00, 0x00, 0x00}, {0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
      {0x14, 0xAA, 0x73, 0x27, 0x00, 0x00, 0x00, 0x00}, {0xB5, 0xE2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
      {0x06, 0x00, 0x00, 0x27, 0x00, 0x00, 0x00, 0x00}, {0x07, 0xEA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
      {0x08, 0x89, 0xAD, 0xFE, 0xAA, 0xE1, 0xAE, 0x02}, {0x09, 0x00, 0xCE, 0x00, 0x03, 0x30, 0x00, 0x00},
      {0xAA, 0x04, 0xE6, 0x9F, 0x04, 0xE9, 0x0F, 0x00}, {0x01, 0x4D, 0x4D, 0x00, 0x00, 0x00, 0x00, 0x00},
      {0x82, 0x52, 0x01, 0x50, 0x5C, 0x00, 0x00, 0x00}, {0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
      {0x44, 0x88, 0x73, 0x27, 0x00, 0x00, 0x00, 0x00}, {0xA5, 0xE2, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
      {0x16, 0x00, 0x00, 0x27, 0x00, 0x00, 0x00, 0x00}, {0x07, 0xEA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
      {0x08, 0xCA, 0xAC, 0xFE, 0xAA, 0xE1, 0xAE, 0x02}, {0x09, 0x00, 0xCE, 0xE0, 0x02, 0x2F, 0x00, 0x00}};
  CAN_frame TESLA_75D = {.FD = false,
                         .ext_ID = false,
                         .DLC = 8,
                         .ID = 0x75D,
                         .data = {0xAA, 0x04, 0xE6, 0x9F, 0x04, 0xE9, 0x0F, 0x00}};
